...
<head>
    ...
    <title>Comprobante Sistema SAC</title>
    <style>
    body {
        width: 21.5cm;
        height: 28cm;
...
<body>
    <div class="positioned item1">15    8      2024</div>
    ...
    <div class="positioned item12">RENOVACION DE NICHO MAYOR</div>
    <div class="positioned item13">135</div>
    <div class="positioned item14">4</div>
    ...
    <div class="positioned item20">137</div>
    <div class="positioned item21">Inhumacion</div>
    <div class="positioned item22">Inhumacion temporal</div>
    <div class="positioned item23">ciento treinta y siete 00/100</div>
</body>
</html>