...
<body>
    <div class="section">
        <div class="positioned item1">
            {{ \Carbon\Carbon::parse($exhumacion->fecha_exhumacion)->format('d    m      y') }}
        </div>
    </div>
    <div class="positioned item2">{{ $ci_nit }}</div>
    <div class="positioned item3">{{ $nombre_contribuayente }}</div>
    <div class="positioned item4">{{ $numero_celular}}</div>
    <div class="positioned item5">{{ $avenida_calle}}</div>
    <div class="positioned item6">{{ $numero_puerta}}</div>
    <div class="positioned item7">{{ $zona}}</div>
    <div class="positioned item8">Exhumacion de Restos Oseos</div>
    ...
    <div class="positioned item12">EXHUMACION DE RESTOS OSEOS</div>
    ...
    <div class="positioned item16">{{ $fecha_exhumacion }}</div>
